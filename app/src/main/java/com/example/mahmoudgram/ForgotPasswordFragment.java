...
public class ForgotPasswordFragment {
    ...
    private void Reset() {
        ...
        etEmailforgot = getView().findViewById(R.id.etEmailMain);
        btnForgot = getView().findViewById(R.id.etPasswordMain);
            ...
            public void onClick(View view) {
                ...
                mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        manager.beginTransaction().replace(R.id.etPasswordMain,LogInFragment,LogInFragment.getTag()).commit();
                    }
                });
            }
        });
